...
namespace {
    ...
    class Cache extends \Illuminate\Support\Facades\Cache{
         ...
         * @static
         */
        public static function getStoregetDefaultDriver(){
        ...
        /**
         * Multi Retrieve an item from the cache by keys.
         *
         * @param array $keys
         * @return mixed
         * @static
        ...
        /**
         * Store an array of item in the cache.
         *
         * @param string $key
         * @param mixed $value
        ...
        /**
         * Store a item list in the cache.
         *
         * @param mixed $values
         * @param \DateTime|int $minutes
         * @return void
