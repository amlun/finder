                                ...
                                <tr>
                                    @foreach($dataType->browseRows as $row)
                                        <td>
                                            ...
                                            @if($row->type == 'image')
                                            <img src="{{ url( '/storage/resize/small/' . $data->{$row->field}) }}">
                                            ...
                                            @elseif($row->type == 'link')
                                                <a href="{{ $data->{$row->field} }}"target="_blank">Source Link</a>
                                    ...
                                    <td class="no-sort no-click" id="bread-actions">
                                        @if (Voyager::can('delete_'.$dataType->name))
                                            <a href="javascript:;" title="Crawl" class="btn btn-sm btn-danger pull-right delete" data-id="{{ $data->id }}" id="crawl-{{ $data->id }}">
                                                <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Crawl</span>
                                            </a>
                                        @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Are you sure you want to crawl
                ...
                <div class="modal-footer">
                    <form action="{{ route('voyager.'.$dataType->slug.'.index') }}" id="delete_form" method="POST">
                        ...
                        <input type="submit" class="btn btn-danger pull-right delete-confirm"
                                 value="Yes, crawl this {{ strtolower($dataType->display_name_singular) }}">
                    </form>
